...
export default function ThpChart({ timestamps, series }) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 col-span-1 lg:col-span-2 relative landscape:p-3">
            ...
            >
                <ResponsiveContainer width="100%" height={350} className="landscape:h-64">
