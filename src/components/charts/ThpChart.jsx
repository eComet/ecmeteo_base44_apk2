...
export default function ThpChart({ timestamps, series }) {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 col-span-1 lg:col-span-2 relative" style={{ transform: 'rotate(270deg)', transformOrigin: 'center', width: '100vh', height: 'auto' }}>
